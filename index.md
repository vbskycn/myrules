# myrules
各种规则自用，克隆自github开源仓库 [blackmatrix7/ios_rule_script](https://github.com/blackmatrix7/ios_rule_script) ，[Loyalsoldier/clash-rules](https://github.com/Loyalsoldier/clash-rules) ，[Aethersailor/Custom_OpenClash_Rules](https://github.com/Aethersailor/Custom_OpenClash_Rules) 自动同步更新，转换成直连地址

还需要什么规则自己替换

```
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master #查找这个网址，替换为下面的地址即可
...
- clash配置文件示例
  ...
  rule-providers:
    ...
    OpenAI:
      type: http
      behavior: "classical"
      url: "https://myrules.zhoujie218.top/rule/Clash/OpenAI/OpenAI.yaml"
